...
*The full signal schema, rules format, and Python utilities are available in the [Decker AI Strategy Builder repo](https://github.com/gigshow/decker-ai-strategy-builder). Trade outcome collection is part of the core pipeline.*
